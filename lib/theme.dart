 ...
 ), bottomAppBarTheme: BottomAppBarTheme(color: Color( 0xffffffff )), colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.red).copyWith(background: Color( 0xffef9a9a )).copyWith(error: Color( 0xffd32f2f )).copyWith(secondary: Color( 0xfff44336 )), textSelectionTheme: TextSelectionThemeData(cursorColor: Color( 0xff4285f4 ), selectionColor: Color( 0xffef9a9a ), selectionHandleColor: Color( 0xffe57373 ),),
  );
